...
Found something interesting on the net? 3xSocializer makes it a breeze to share it with the world. Part of Don Crowther's 3xSocial course.
...
__IMPORTANT!__ If you previously installed 3xSocializer plugin from a zip file and not from wordpress.org, please _uninstall it first_ -- do not upgrade to the version hosted on wordpress.org directly from the zip file version, this is due to a plugin directory naming conflict.
